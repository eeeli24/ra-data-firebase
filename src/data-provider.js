...
const RestProvider = (firebaseConfig = {}, options = {}) => {
    ...
    return async (type, resourceName, params) => {
        ...
        switch (type) {
            case GET_LIST:
                result = await getList(params, resourceName, resourcesData[resourceName], timestampFieldNames);
                return result;
            case GET_MANY:
                result = await getMany(params, resourceName, resourcesData[resourceName], timestampFieldNames);
                return result;
